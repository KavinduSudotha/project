...
const Sidebar = () => {
  ...
  const sections = [
    ...
    { name: 'Price List', icon: FiShoppingCart, subSections: [{ name: 'Add', link: '/AddPriceList' }, 'View', 'Records'] },
    { name: 'RAW', icon: FiPackage, subSections: [{ name: 'Buy', link: '/rawbuy' }, { name: 'Use', link: '/rawuse'}, { name: 'Sell', link: '/sell'}] },
